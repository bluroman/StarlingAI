...
#ifndef ADMOBANE_FW_SWIFT_H
#define ADMOBANE_FW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AdMobANE_FW",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface SwiftController (SWIFT_EXTENSION(AdMobANE_FW))
